...
public class LinkedTree {
    ...
    /*
    takes takes an integer key as its only parameter and that uses uses iteration to determine and return the depth of the node with that key. 
    */
    ...
    */
    private static int numLeafNodesInTree (Node r) {
        if (r == null){
            return 0;
        }
        ...
        if (r.right == null && r.left == null ){
            ...
            return numLeafNodesInTree (r.left)+ numLeafNodesInTree ( r.right);
        }

    }

    /*
    public non-static method called numLeafNodes()
    */
    ...
    /*
     takes no parameters and that uses iteration to find and delete the node containing the smallest key in the tree; it should also return the value of the key whose node was deleted.
    */
    ...
    public static void main(String[] args) {
        ...
        System.out.println("--- Testing numLeafNodesInTree()/numLeafNodes() from Problem 4 ---");
        System.out.println();
        System.out.println("(1) Testing on tree from Problem 8, number of empty node");
        try {
            LinkedTree tree = new LinkedTree();
        ...
        System.out.println("--- Testing numLeafNodesInTree()/numLeafNodes() from Problem 4 ---");
        System.out.println();
        System.out.println("(2) Testing on tree from Problem 8, number of leaf node ");
        try {
            LinkedTree tree = new LinkedTree();
        ...
        System.out.println("--- Testing deleteSmallest() from Problem 4 ---");
        System.out.println();
        System.out.println("(3) Testing on tree from Problem 8, delete Smallest");
        try {
            LinkedTree tree = new LinkedTree();           
        ...
        System.out.println("--- Testing deleteSmallest() from Problem 4 ---");
        System.out.println();
        System.out.println("(4) Testing on tree from Problem 8, delete Smallest");
        try {
            LinkedTree tree = new LinkedTree();
